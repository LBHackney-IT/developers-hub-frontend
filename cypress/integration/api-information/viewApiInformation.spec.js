...
describe("Edge Cases", () => {
	...
	it("Shows error response if Swagger API error occurs", function () {
		// arrange
		...
		cy.get(".env-tags").should("contain", "We are having difficulty loading this data.");
		cy.contains("SwaggerHub Specification")
			.next(".govuk-table__cell")
			.should("contain", "We are having difficulty loading this data.");
		cy.contains("Version")
			.next(".govuk-table__cell")
			.should("contain", "We are having difficulty loading this data.");
	});
